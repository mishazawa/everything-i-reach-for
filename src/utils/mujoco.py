...
# https://github.com/thu-ml/tianshou/blob/master/examples/mujoco/mujoco_env.py
...
def make_mujoco_env_watch(task: str) -> Env:
    return MujocoEnvFactory(task).create_env(EnvMode.WATCH)
